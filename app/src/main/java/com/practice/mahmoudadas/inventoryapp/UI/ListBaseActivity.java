...
// parent activity for all activities that have ListView
abstract class ListBaseActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
